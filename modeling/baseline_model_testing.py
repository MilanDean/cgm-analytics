...
if __name__ == '__main__':
    ...
    df = df.drop(columns = 'eA1c', axis = 1)
    df.head()
    ...
    train_X, train_Y, test_X, test_Y = set_up_train_test_data(train_df, test_df)
    ...
    plt.savefig('../data/output/training/LogReg_corrmap_{}.png'.format(datetime.today().strftime('%Y%m%d')))
    plt.close()
